document.addEventListener("DOMContentLoaded", function () {
  ...
  if (auth0Wrapper) auth0Wrapper.style.display = "none";

   if (!document.getElementById("main-unblock")) {
    ...
    main.innerHTML = `
      <div id="unblock-container">
        ...
        <div id="button-container-unblock">
          <button id="button-unblock" type="button">
  ...
  const customBtn = document.getElementById("button-unblock");
  if (!customBtn) return;
